...
while(guiCommands['runLoop']):
	...
	if inputImage is not None:
		...
		while guiCommands['mode']=='show':
			...
			HSVmask = cv2.inRange(hsvImage, light_green, dark_green)
			...
			cv2.putText(HSVmaskedImage,str(light_green),(20,40),font,1,(0,255,0), 1,cv2.LINE_AA)
			cv2.putText(HSVmaskedImage,str(dark_green),(20,80),font,1,(0,255,0), 1,cv2.LINE_AA)
		...
		if guiCommands['mode']=='savePic':
			colorString=str(light_green)+str(dark_green)
			...
			saveNameAlpha='alpha_'+fileName+'.png'
